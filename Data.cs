...
namespace BloxStreet_Trainer
{
    internal class Data
    {
        ...
        public static List<string> register_test_script = new List<string>
        {
            ...
            "When a customer requests to proceed with checkout, ask them to scan their loyalty card.",
            "After that, tell them their total like \"Your total today is $0.00\".",
            "Then, based on the guest's preference, click either \"Robux Payment\" or \"Card Payment\" to proceed with the payment process.",
